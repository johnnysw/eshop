                ...
                <div class="col-sm-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="adv-table">
                                <div></div>
                                <table class="table table-striped table-bordered" id="user-table" cellspacing="0"
                                       width="100%">
                                    <thead>
                                    <tr>
...
<script id="user-tpl" type="text/html">
    <?php include 'tpls/user_tpl.html'; ?>
</script>
<script id="new-user-tpl" type="text/html">
    <?php include 'tpls/new_user_tpl.html'; ?>
</script>
<script id="edit-user-tpl" type="text/html">
    <?php include 'tpls/edit_user_tpl.html'; ?>
</script>
<script id="send-message-tpl" type="text/html">
    <?php include 'tpls/send_message_tpl.html'; ?>
</script>
